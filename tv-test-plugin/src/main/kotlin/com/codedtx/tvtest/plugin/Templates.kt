...
# Auto-generated by com.codedtx.tv-test plugin — do not edit manually.
# Bump the plugin version to pull in CI improvements.
name: UI Tests
...
jobs:
  ui-tests:
    uses: codedtx/android-tv-testing/.github/workflows/tv-ui-tests.yml@main
    with:
      module: $module
      flavor: $flavorGradle
      app-id: $appId
...
jobs:
  screenshots:
    uses: codedtx/android-tv-testing/.github/workflows/tv-screenshots.yml@main
    with:
      module: $module
      flavor: $flavorGradle
      app-id: $appId
